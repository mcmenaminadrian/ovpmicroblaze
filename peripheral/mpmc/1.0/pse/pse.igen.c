...
// eg. if (diagnosticLevel > 0) bhmMessage("I", "mpmc", "Example");
...
static void installSlavePorts(void) {
    ...
    ppmInstallReadCallback(readMemCB, (void*)0x0, handles.plb+0x0, 0x80);
    ppmInstallWriteCallback(writeMemCB, (void*)0x0, handles.plb+0x0, 0x80);
}
