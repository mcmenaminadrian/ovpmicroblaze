...
// eg. if (diagnosticLevel > 0) bhmMessage("I", "xps-sysace", "Example");
...
static void installSlavePorts(void) {
    ...
    ppmInstallReadCallback(readMemCB, (void*)0x0, handles.plb+0x0, 0x10000);
    ppmInstallWriteCallback(writeMemCB, (void*)0x0, handles.plb+0x0, 0x10000);
}
