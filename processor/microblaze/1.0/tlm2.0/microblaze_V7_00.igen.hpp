...
#ifndef XILINX_OVPWORLD_ORG_PROCESSOR_MICROBLAZE_V7_00__1_0
#define XILINX_OVPWORLD_ORG_PROCESSOR_MICROBLAZE_V7_00__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class microblaze_V7_00 : public icmCpu
{
  private:
    const char *getModel() {
