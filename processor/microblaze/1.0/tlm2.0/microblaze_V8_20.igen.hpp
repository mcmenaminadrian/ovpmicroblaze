...
//
//                             Version 20140731.0
//                          Mon Aug  4 13:39:20 2014
//
////////////////////////////////////////////////////////////////////////////////

#ifndef XILINX_OVPWORLD_ORG_PROCESSOR_MICROBLAZE_V8_20__1_0
#define XILINX_OVPWORLD_ORG_PROCESSOR_MICROBLAZE_V8_20__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class microblaze_V8_20 : public icmCpu
{
  private:
    const char *getModel() {
